...
* :file:`boards/custom_nrf9160_ns.conf` - Configuration file specific for the custom board.
  This file is automatically merged with the :file:`prj.conf` file when you build for the ``custom_nrf9160_ns`` build target.
